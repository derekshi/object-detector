...
if __name__ == "__main__":
    ...
    fd = hog(resized, orientations, pixels_per_cell, cells_per_block, 'L2-Hys', visualize, normalize)
    ...
    #         fd = hog(im_window, orientations, pixels_per_cell, cells_per_block, 'L2-Hys', visualize, normalize)
    #         pred = clf.predict(fd)
    #         if pred == 1:
